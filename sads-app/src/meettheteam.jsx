...
```
  <div className="team-grid">
    ...
    <Modal
      trigger={
        <div className="team-card">
          <img src="https://newsadseditor-production.up.railway.app/uploads/nia.jpg" alt="Nia Savova" className="team-img" />
    ...
    >
      ...
      <img src="https://newsadseditor-production.up.railway.app/uploads/nia.jpg" style={{ width: "250px" }} alt="inside modal" />
    </Modal>
    ...
    <Modal
      trigger={
        <div className="team-card">
          <img src="https://newsadseditor-production.up.railway.app/uploads/sarah.jpg" alt="Sarah Mendoza" className="team-img" />
          <div style={{ padding: "8px" }}>
    ...
    >
      ...
      <img src="https://newsadseditor-production.up.railway.app/uploads/sarah.jpg" style={{ width: "300px" }} alt="inside modal" />
    </Modal>
    ...
    <Modal
      trigger={
        <div className="team-card">
          <img src="https://newsadseditor-production.up.railway.app/uploads/mara.jpg" alt="Margaret Alt" className="team-img" />
          <div style={{ padding: "8px" }}>
    ...
    >
      ...
      <img src="https://newsadseditor-production.up.railway.app/uploads/mara.jpg" style={{ width: "300px", height: "300px" }} alt="inside modal" />
    </Modal>
    ...
    <Modal
      trigger={
        <div className="team-card">
          <img src="https://newsadseditor-production.up.railway.app/uploads/hillary.jpg" alt="Hillary Bhuiyan" className="team-img" />
          <div style={{ padding: "8px" }}>
    ...
    >
      ...
      <img src="https://newsadseditor-production.up.railway.app/uploads/hillary.jpg" style={{ width: "300px" }} alt="inside modal" />
    </Modal>
    ...
    <Modal
      trigger={
        <div className="team-card">
          <img src="https://newsadseditor-production.up.railway.app/uploads/radha.jpg" alt="Radha Chitgopkar" className="team-img" />
          <div style={{ padding: "8px" }}>
    ...
    >
      ...
      <img src="https://newsadseditor-production.up.railway.app/uploads/radha.jpg" style={{ width: "300px" }} alt="inside modal" />
    </Modal>
    ...
    <Modal
      trigger={
        <div className="team-card">
          <img src="https://newsadseditor-production.up.railway.app/uploads/christian.jpg" alt="Christian Sheehan" className="team-img" />
          <div style={{ padding: "8px" }}>
    ...
    >
      ...
      <img src="https://newsadseditor-production.up.railway.app/uploads/christian.jpg" style={{ width: "300px" }} alt="inside modal" />
    </Modal>
    ...
    <Modal
      trigger={
        <div className="team-card">
          <img src="https://newsadseditor-production.up.railway.app/uploads/ameen.jpg" alt="Ameen Zia" className="team-img" />
          <div style={{ padding: "8px" }}>
    ...
    >
      ...
      <img src="https://newsadseditor-production.up.railway.app/uploads/ameen.jpg" style={{ width: "300px" }} alt="inside modal" />
    </Modal>
  </div>
