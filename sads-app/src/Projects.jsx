...
const Projects = () => {
    ...
    useEffect(() => {
    fetch("https://sadsapi-616938642091.europe-west1.run.app/projects")
      .then((res) => res.json())
      .then((data) => setImages(data.projects))
  ...
  <div style={overlayStyle} onClick={() => setModalOpen(false)}>
    ...
    >
      ...
      <h2 style={titleStyle}>{modalData.title} • {modalData.author}</h2>
