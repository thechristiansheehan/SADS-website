...
const containerStyle = publicView
  ? {
      ...
      gap: "20px",
      marginTop: isActive && images ? "0px" : "0px",
      marginBottom: isActive && images ? "0px" : "30px",
      marginLeft: "30px",
      marginRight: "30px",
    }
  : {
...
if (loading && showLoading) {
  ...
  if (showLoading && (!images || orderedImages.length === 0) && isActive) {
    return (
        ...
        {orderedImages.map((img) => {
          ...
          const cardContent = (
            ...
            >
              ...
              {showDelete && (
                <button
                  onClick={() => onActive(img.id)}
                  style={{
                    position: "absolute",
                    top: "5px",
                    left: "5px",
                    background: img.active ? "#009712" : "#a93226",
                    color: "white",
                    border: "none",
                    height: "25px",
                    cursor: "pointer",
